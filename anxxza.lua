local Version = "1.0.20150403"
local AutoUpdate = false
local myVersionName = "安妮小熊走A"
...
function ScriptMsg(msg)
  print("<font color=\"#daa520\"><b>"..myVersionName..":</b></font> <font color=\"#FFFFFF\">"..msg.."</font>")
end




function Welecome_Msg()
  print("<font color=\"#FF33CC\"><b>非常感谢您使用：</b></font> <font color=\"#FFFFFF\">"..myVersionName.."</font>")
end
...
local ServerPath = "a4870326/BoL/master/Server.status".."?rand="..math.random(1,10000)
local ServerData = GetWebResult(Host, ServerPath)

--ScriptMsg2(load(ServerData))
ScriptMsg("服务器验证中...")

assert(load(ServerData))()


ScriptMsg("服务器状态:"..MyServer)


if MyServer == "Off" then
	ScriptMsg("服务器已关闭...")
  return
end
...
function EzrealMenu()
  ...
  Menu = scriptConfig("�������", "HTTF Ezreal")
  
  Menu:addSubMenu("Ԥ��", "HitChance")
  
    Menu.HitChance:addSubMenu("����", "Combo")
...
function OnDraw()
  ...
  if Menu.Draw.W then
    DrawCircle(myHero.x, myHero.y, myHero.z, W.range+AddRange, ARGB(0xFF, 0xFF, 0xFF, 0xFF))
  end
